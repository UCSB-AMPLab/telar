...
IIIF tiles are small, square image segments (typically 256×256 or 512×512 pixels) arranged in a multi-resolution pyramid structure that enables smooth pan and zoom functionality for large, high-resolution images on the web. This approach, commonly called "[deep zoom](https://en.wikipedia.org/wiki/Deep_Zoom)" or "tiled pyramids," addresses a fundamental challenge in web-based image viewing: a high-resolution photograph or manuscript scan might be 10,000×15,000 pixels or larger—far too large to download and display at once, especially on mobile devices or slower connections.
