...
Markdown is a lightweight markup language created in 2004 by [John Gruber](https://daringfireball.net/) (with significant collaboration from [Aaron Swartz](https://en.wikipedia.org/wiki/Aaron_Swartz)) with the philosophy that plain text formatting should be readable as-is, even before being converted to HTML or other output formats. Unlike word processors that hide formatting codes or markup languages like HTML that clutter text with tags, Markdown uses simple, intuitive syntax that mimics how people naturally emphasize text in plain-text emails: asterisks for emphasis (`*italic*` or `**bold**`), hash marks for headings (`# Heading`), brackets for links (`[text](url)`), and dashes for lists.
...
Since its creation, Markdown has become ubiquitous in technical documentation (GitHub, Stack Overflow), academic writing (R Markdown, Jupyter notebooks), content management systems (WordPress, Ghost, static site generators), note-taking applications (Obsidian, Notion, Bear), and messaging platforms (Slack, Discord). Its success stems from solving a fundamental tension in digital writing: how to add formatting and structure without sacrificing readability or requiring complex software.
