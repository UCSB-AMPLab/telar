...
# Video URL patterns for media type auto-detection (D-14, v0.10.0)
...
def detect_media_type(source_url, object_id):
    """Auto-detect media type for gallery Type filter (D-14, v0.10.0).
...
def generate_objects():
    ...
    for obj in objects:
        ...
        if media_type == 'Audio':
            # Duration from peaks JSON (generated by Phase 04 audio pipeline)
